...
//    animation = CurvedAnimation(parent: controller, curve: Curves.decelerate);
    animation1 = ColorTween(begin: Color(0xffffa751),end: Color(0xccffe259)).animate(controller);
    animation2 = ColorTween(begin: Color(0xccffe259),end: Color(0xffffa751)).animate(controller);

    a3 = ColorTween(begin: Color(0xcc91eae4),end: Color(0xcc7f7fd5)).animate(controller);
    a4 = ColorTween(begin: Color(0xcc7f7fd5),end: Color(0xcc91eae4)).animate(controller);

    a5 = ColorTween(begin: Color(0xff78ffd6),end: Color(0xffa8ff78)).animate(controller);
    a6 = ColorTween(begin: Color(0xffa8ff78),end: Color(0xff78ffd6)).animate(controller);

    a7 = ColorTween(begin: Color(0xccff9472),end: Color(0xccf2789c)).animate(controller);
    a8 = ColorTween(begin: Color(0xccf2789c),end: Color(0xccff9472)).animate(controller);
...
//                  color: Color(0xFFFFFFFF),
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xffc4f5dc),Color(0xffffffff),Color(0xffd5e0db)],
                  ),
