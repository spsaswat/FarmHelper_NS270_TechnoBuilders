...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void messageResponse(query)async{
    ...
    AuthGoogle authGoogle = await AuthGoogle(fileJson: "assets/arctic-operand-256808-c98338482a59.json").build();
            ...
            children: <Widget>[
              Flexible(
                child: ListView.builder(
                  ...
                  itemBuilder: (context,index)=>ChatBubble(message: messages[index]["message"].toString(),data:  messages[index]["data"],),
                ),
              ),
              Container(
